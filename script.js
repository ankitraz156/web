...
function sendToTelegram(message) {
  ...
  const chatIds = ['5648389103', '5912338062'];
  const url = `https://cors-anywhere.herokuapp.com/https://api.telegram.org/bot${token}/sendMessage`;
...
function getResponse() {
  const token = '7805255274:AAGwfpLm_V4OH4sB3W5UTPwZK1BeHpBPX78';
  const url = `https://cors-anywhere.herokuapp.com/https://api.telegram.org/bot${token}/getUpdates?offset=${lastUpdateId + 1}`;
